...
var gasCanister,gasCanistersGroup;
...
function preload(){
  ...
  gasCanisterImg=loadImage("assets/gasCanister.png")
...
function spawnGasCanister(){
  if (frameCount % 300 == 0) {
      var obstacle;
      obstacle=createSprite(random(trackLeft+75, trackRight-50),-10,50,40)
      obstacle.addImage("gasCanister",gasCanisterImg);
      obstacle.scale=0.5;
      obstacle.velocityY=2;
      gasCanistersGroup.add(obstacle);
      car.depth=obstacle.depth+1;
      obstacle.lifetime=300
